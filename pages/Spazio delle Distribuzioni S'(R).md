...
- Si tratta ora di trovare uno spazio che contenga sia i segnali rappresentati da funzioni di $L^1(\R), L^2(\R)$$ o $L^∞(\R)$, sia quelli rappresentati da distribuzioni $δ_a$o
