  ...
  card-last-score:: 1
	...
	- ## Spazi di Banach #card
	  ...
	  card-last-score:: 1
		...
		- $(\L1I, \norm_1I),  (\L2I, \norm_2I), (\L∞I,\norm_∞I)$, sono spazi di Banach, ovvero spazi vettoriali normati completi.
...
- # Spazio L2
	- ## Spazio di Hilbert #card
	  ...
	  card-last-score:: 1
		- $(2I, \norm_2I)$ è uno **spazio di Hilbert**, ovvero la norma $\norm_{2I}$ proviene da un prodotto interno. Precisamente:
			- $$\|f\|_{2I} = \sqrt{(f, f)_{2I}}$$
		- dove:
			- $$(f, g)_{2I} = \int_I f(t) \overline{g(t)}\,dt$$
				- $\forall\,f,g \in 2I$
		- Ciò permette di definire il concetto di **ortogonalità** come:
			- $$f \perp g \text{ se } (f, g)_{2I} = 0$$
	- ## Disuguaglianza di Schwartz #card
	  ...
	  card-last-score:: 1
		- $$\int_I |f(t)| |g(t) | \,dt \le \|f\|_2I \|g\|_{2I}$$
		- Da questa segue che $f, g \in 2I \Rightarrow fg \in 1I$, dato che:
		- $$\|fg\|_{L^1(I)} = \int_I|f(t)||g(t)|$$
			- Ed è minorato da un numero ben definito.
	- ## Energia
	  collapsed:: true
		- Fisicamente $\|f\|_2I^2$ rappresenta l'energia del segnale $f \in 2I$.
		...
		- L'energia totale sarà allora:
		  collapsed:: true
			- $$
			  ...
			  \end{aligned}
			  $$
		- Da questo si può giustificare il perché $\norm{2I}$ rappresenta l'energia del segnale.
	- ## Base ortonormale #card
	  ...
	  card-last-score:: 1
		- ### Definizione
			- Siano $\phi_n \in 2I$ con $n \in \Z$.
			  id:: 64fb54d1-5aba-486b-aa5b-d872d8b3e3f4
			  L'insieme di funzioni $\{\phi_n\}_{n \in \Z}$ si dice **base ortonormale** di $2I$ se:
				- logseq.order-list-type:: number
				  id:: 64fb54d4-0529-40b3-865d-11d7dd6b598c
				  $$
				  (\phi_n, \phi_m)_2I = \begin{cases}
				  0 & \text{per } n \neq m \\
				  1 & \text{per } n = m
				  \end{cases}
				  $$
					- Le funzioni $\phi_n$ sono ortogonali a due a due ed hanno $\|\phi_n\|_{2I} = 1$
				- logseq.order-list-type:: number
				  ...
				  \text{dove }\,c_n = (f, \phi_n)_{2I} \quad\quad\quad&\text{Coefficienti di Fourier}
				  \end{aligned}
				  $$
		...
		- #### Nota
		  collapsed:: true
			...
			- $$
			  \begin{gathered}
			  f = \sum\limits_{-\infty}^{+\infty} c_n \phi_n \\\Updownarrow \\\lim_{N \rightarrow \infty} \left\| f - \sum\limits_{n = -N}^N c_n\phi_n \right\| _{2I} = 0
			  \end{gathered}
			  $$
		- ### Uguaglianza di Parseval #card
		  ...
		  card-last-score:: 1
			- Sia $\{\phi_n\}$ con $n \in \Z$ (o $n \in \N$) una base ortonormale di $2I$.
			- $\forall f \in 2I$ si ha:
				- $$\|f\|_2I^2 = \sum\limits_n |c_n|^2$$
			...
			- Nel caso particolare $I = \{1,2,3\}$ le funzioni $f: I \rightarrow \R$ coincidono con i vettori dello spazio $\R^3$ e l'uguaglianza di Parseval coincide con il teorema di Pitagora.
			  collapsed:: true
				...
				- $$\|x\|_2I^2 = \sum\limits_{n=1}^3|c_n|^2 = |x_1|^2 + |x_2|^2 + |x_3|^2$$
					- $$
					  \begin{aligned}
					  \phi_1 &= e_1 = (1, 0, 0) \\
					  \phi_2 &= e_2 = (0, 1, 0) \\
						...
						- Bisogna provare le due condizioni:
							- {{embed ((64fb54d4-0529-40b3-865d-11d7dd6b598c))}}
								...
								- Se $n \neq m$:
									- $$
									  \begin{aligned}
									  (e_\lambda^n, e_\lambda^m)_2I &= ∫_0^\frac{1}{λ}e_λ^n(t)\overline{e_λ^m(t)}
									  \\
